...
#==========================================================
```{r Read Data}
# Load Daily Sales Returns Data 
onlineDailySalesReturns = read.dta13("online daily sales-returns data.dta")
# Print summary statistics
stargazer(onlineDailySalesReturns, 
          type  = "text", median = TRUE, 
          iqr   = TRUE, digits = 2, 
          title = "Online Sales and Return Level Descriptive Statistics")  
```

```{r Q1 and Q2 Data Distributions}
# 
ggplot(odsr, aes(x=salesvalue)) + geom_histogram(colour="red") 
ggplot(onlineDailySalesReturns, aes(x=log(salesvalue))) + geom_histogram(colour="green") 
#Need to use log-transformed sales value
ggplot(onlineDailySalesReturns, aes(x=returnvalue)) + geom_histogram(colour="red") 
ggplot(onlineDailySalesReturns, aes(x=log(returnvalue))) + geom_histogram(colour="green") 
#Need to use log-transformed return values
ggplot(onlineDailySalesReturns, aes(x=salesquantity)) + geom_histogram(colour="red") 
ggplot(onlineDailySalesReturns, aes(x=log(salesquantity))) + geom_histogram(colour="green") 
#Need to use log-transformed sales quantity
ggplot(onlineDailySalesReturns, aes(x=returnquantity)) + geom_histogram(colour="red") 
ggplot(onlineDailySalesReturns, aes(x=log(returnquantity))) + geom_histogram(colour="green") 
#Need to use log transformed return quantity
ggplot(onlineDailySalesReturns, aes(x=avg_female)) + geom_histogram(colour="red") 
ggplot(onlineDailySalesReturns, aes(x=log(avg_female))) + geom_histogram(colour="green") 
ggplot(onlineDailySalesReturns, aes(x=avg_age)) + geom_histogram(colour="red") 
ggplot(onlineDailySalesReturns, aes(x=log(avg_age))) + geom_histogram(colour="green") 
ggplot(onlineDailySalesReturns, aes(x=avg_homeowner)) + geom_histogram(colour="red") 
ggplot(onlineDailySalesReturns, aes(x=log(avg_homeowner))) + geom_histogram(colour="green") 
ggplot(onlineDailySalesReturns, aes(x=avg_residency)) + geom_histogram(colour="red") 
ggplot(onlineDailySalesReturns, aes(x=log(avg_residency))) + geom_histogram(colour="green") 
ggplot(onlineDailySalesReturns, aes(x=avg_childowner)) + geom_histogram(colour="red") 
ggplot(onlineDailySalesReturns, aes(x=log(avg_childowner))) + geom_histogram(colour="green") 
#Use any of the AVG variables. 
stargazer(onlineDailySalesReturns, type="text", median=TRUE, iqr=TRUE,digits=2, title="Online Sales and Return Level Descriptive Statistics")  
```
...
odsr = subset(onlineDailySalesReturns, day < 786)
odsr$bops_avail = ifelse(odsr$day > 366, 1, 0) #1 if after day 366 and before 786, 0 before 366. 
odsr$storegroup = ifelse((odsr$store_number == 2 | odsr$store_number == 6), 1,
                          0) #Store 2 and 6 = 1 and 5998 = 0
stargazer(odsr, type = "text", median = TRUE, iqr = TRUE, digits = 2,
          title = "Online Sales and Return Level Descriptive Statistics")

odsr$logSalesValue = log(odsr$salesvalue + 1)
odsr$logReturnValue = log(odsr$returnvalue + 1)

# Replace NA with sample mean 
odsr$avg_female[is.na(odsr$avg_female)] <- 0.52
odsr$avg_income[is.na(odsr$avg_income)] <- 5.38
odsr$avg_age[is.na(odsr$avg_age)] <- 5.07
odsr$avg_homeowner[is.na(odsr$avg_homeowner)] <- 0.66
odsr$avg_childowner[is.na(odsr$avg_childowner)] <- 0.35
odsr$avg_residency[is.na(odsr$avg_residency)] <- 7.06

stargazer(odsr, type="text", median=TRUE, iqr=TRUE,digits=2, title="Online Sales and Return Level Descriptive Statistics")
...
```{r Q1 Sales Value}
sales1 = lm(LogSalesValue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
              avg_residency+avg_childowner, data=odsr)
stargazer(sales1, 
...
salesquantp = glm(salesquantity~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                    avg_residency+avg_childowner, family = "poisson", data=odsr)
stargazer(salesquantp, 
          title="Regression Results", type="text", 
          column.labels=c( "Sales Quantity"),
          df=FALSE, digits=2, star.cutoffs = c(0.05,0.01,0.001)) 
salesquant1 = glm(salesquantity~1, family = "poisson", data=odsr)

lrtest(salesquantp, salesquant1) #LR Test is significant. The Poisson model does not fit data.

salesquantnb = glm.nb(salesquantity~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                        avg_residency+avg_childowner, data=odsr)
salesquantnb1 = glm.nb(salesquantity~1, data=odsr)
...
```{r Q2 Return Value}
returnval = lm(log(returnvalue+1)~bops_avail*storegroup+salesvalue+avg_female+avg_age+avg_income+avg_homeowner+
                 avg_residency+avg_childowner, data=odsr) #Salesvalue as control. 
stargazer(returnval, 
...
returnquant = glm(returnquantity~bops_avail*storegroup+salesquantity+avg_female+avg_age+avg_income+avg_homeowner+
                    avg_residency+avg_childowner, family = "poisson", data=odsr) #Salesquantity as control. 

stargazer(returnquant, 
          title="Return Quantity Poisson Results", type="text", 
          column.labels=c( "Sales Quantity"),
          df=FALSE, digits=2, star.cutoffs = c(0.05,0.01,0.001)) 
returnquant1 = glm(returnquantity~1, family = "poisson", data = odsr)
#Model Assessment
lrtest(returnquant, returnquant1)
#LR test shows p value as significant. Poisson model does not fit our data. 

returnquantNB = glm.nb(returnquantity~bops_avail*storegroup+salesquantity+avg_female+avg_age+avg_income+avg_homeowner+
                         avg_residency+avg_childowner, data=odsr)
returnquantNB1 = glm.nb(returnquantity~1, data=odsr)
...
finalpcat$bops_avail = ifelse(finalpcat$day > 366, 1, 0) #1 if after day 366 and before 786, 0 before 366. 
...
salesval = lm(Logsalesvalue~bops_avail*storegroup+product_category+avg_female+avg_age+avg_income+avg_homeowner+
...
meffects = ggpredict(salesval, terms = c("bops_avail", "storegroup"))
ggplot(meffects,aes(x, predicted, colour=group)) + geom_line(size=1.3) + 
...
salesquant = glm(salesquantity~bops_avail*storegroup+product_category+avg_female+avg_age+avg_income+avg_homeowner+
...
salesquantnb = glm.nb(salesquantity~bops_avail*storegroup+product_category+avg_female+avg_age+avg_income+avg_homeowner+
              avg_residency+avg_childowner, data=finalpcat)
...
#Marginal Plots
meffects2 = ggpredict(salesquantnb, terms = c("bops_avail", "storegroup"))
ggplot(meffects2,aes(x, predicted, colour=group)) + geom_line(size=1.3) + 
...
returnval = lm(Logreturnvalue~bops_avail*storegroup+product_category+avg_female+avg_age+avg_income+avg_homeowner+
              avg_residency+avg_childowner, data=finalpcat)
stargazer(returnval, 
          title="Regression Results", type="text", 
          column.labels=c( "Sales Value"),
...
#Significant KIV coefficient. 
#Marginal Plots
meffects3 = ggpredict(returnval, terms = c("bops_avail", "storegroup"))
...
returnquant = glm(returnquantity~bops_avail*storegroup+product_category+avg_female+avg_age+avg_income+avg_homeowner+
              avg_residency+avg_childowner, family = "poisson", data=finalpcat)
stargazer(returnquant, 
          title="Regression Results", type="text", 
...
returnquantnb = glm.nb(returnquantity~bops_avail*storegroup+product_category+avg_female+avg_age+avg_income+avg_homeowner+
              avg_residency+avg_childowner, data=finalpcat)
...
meffects4 = ggpredict(returnval, terms = c("bops_avail", "storegroup"))
...
```{r Q6 Sales Value}
salesprodcat = lm(Logsalesvalue~bops_avail*storegroup*product_category+avg_female+avg_age+avg_income+avg_homeowner+
              avg_residency+avg_childowner, data=finalpcat)
...
stargazer(salesprodcat,    
          ...
          column.labels=c("HW-Robust"),
          df=FALSE, digits=2, star.cutoffs = c(0.05,0.01,0.001))
meffects5 = ggpredict(salesprodcat, terms = c("bops_avail", "storegroup", "product_category"))
...
salesprodcat1 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
salesprodcat2 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
salesprodcat3 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
salesprodcat4 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
meffectsprod4 = ggpredict(salesprodcat4, terms = c("bops_avail", "storegroup"))
...
salesprodcat5 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
salesprodcat7 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
salesprodcat9 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
salesprodcat12 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
salesprodcat13 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
salesprodcat14 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
meffectsprod14 = ggpredict(salesprodcat14, terms = c("bops_avail", "storegroup"))
...
salesprodcat21 = lm(Logsalesvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
```{r Q6 Sales Quantity }
salesquanttrip = glm(salesquantity~bops_avail*storegroup*product_category+avg_female+avg_age+avg_income+avg_homeowner+
              avg_residency+avg_childowner, family = "poisson", data=finalpcat)
...
salesquanttripnb = glm.nb(salesquantity~bops_avail*storegroup*product_category+avg_female+avg_age+avg_income+avg_homeowner+
              avg_residency+avg_childowner, data=finalpcat)
...
meffects6 = ggpredict(salesquanttripnb, terms = c("bops_avail", "storegroup", "product_category"))t
...
```{r Q6 Return Value}
returnvaltrip = lm(Logreturnvalue~bops_avail*storegroup*product_category+avg_female+avg_age+avg_income+avg_homeowner+
              avg_residency+avg_childowner, data=finalpcat)
...
stargazer(returnvaltrip,    
          ...
          column.labels=c("HW-Robust"),
          df=FALSE, digits=2, star.cutoffs = c(0.05,0.01,0.001))
meffects7 = ggpredict(returnvaltrip, terms = c("bops_avail", "storegroup", "product_category"))
...
product1 = subset(finalpcat, product_category == 1)
returnvaltrip1 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                     avg_residency+avg_childowner, data=product1)
...
product2 = subset(finalpcat, product_category == 2)
returnvaltrip2 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                      avg_residency+avg_childowner, data=product2)
...
product3 = subset(finalpcat, product_category == 3)
returnvaltrip3 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                      avg_residency+avg_childowner, data=product3)
...
product4 = subset(finalpcat, product_category == 4)
returnvaltrip4 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                      avg_residency+avg_childowner, data=product4)
...
meffectsprod4r = ggpredict(returnvaltrip4, terms = c("bops_avail", "storegroup"))
...
product5 = subset(finalpcat, product_category == 5)
returnvaltrip5 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                      avg_residency+avg_childowner, data=product5)
...
returnvaltrip6 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
product7 = subset(finalpcat, product_category == 7)
returnvaltrip7 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                      avg_residency+avg_childowner, data=product7)
...
product9 = subset(finalpcat, product_category == 9)
returnvaltrip9 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                      avg_residency+avg_childowner, data=product9)
...
returnvaltrip11 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
product12 = subset(finalpcat, product_category == 12)
returnvaltrip12 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                      avg_residency+avg_childowner, data=product12)
...
product13 = subset(finalpcat, product_category == 13)
returnvaltrip13 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                      avg_residency+avg_childowner, data=product13)
...
product14 = subset(finalpcat, product_category == 14)
returnvaltrip14 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                      avg_residency+avg_childowner, data=product14)
...
meffectsprod14r = ggpredict(returnvaltrip14, terms = c("bops_avail", "storegroup"))
...
returnvaltrip20 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
...
product21 = subset(finalpcat, product_category == 21)
returnvaltrip21 = lm(Logreturnvalue~bops_avail*storegroup+avg_female+avg_age+avg_income+avg_homeowner+
                       avg_residency+avg_childowner, data=product21)
...
meffectsprod21r = ggpredict(returnvaltrip21, terms = c("bops_avail", "storegroup"))
...
returnquanttrip = glm(returnquantity~bops_avail*storegroup*product_category+avg_female+avg_age+avg_income+avg_homeowner+
              avg_residency+avg_childowner, family = "poisson", data=finalpcat)
...
returnquanttripnb = glm.nb(returnquantity~bops_avail*storegroup*product_category+avg_female+avg_age+avg_income+avg_homeowner +
              avg_residency+avg_childowner, data=finalpcat)
...
meffects8 = ggpredict(returnquanttripnb, terms = c("bops_avail", "storegroup", "product_category"))
...
CheckHeteroscedasticity(returns.lm, plot = FALSE)
```
